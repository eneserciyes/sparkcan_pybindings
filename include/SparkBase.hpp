...
//   // Misc
//   kInverted                          = 45,
//   kReserved_46                       = 46,  // was OutputRatio in old table
//   kReserved_47                       = 47,  // was SerialNumberLow
//   kReserved_48                       = 48,  // was SerialNumberMid
//   kReserved_49                       = 49,  // was SerialNumberHigh
...
//   // Motor constants
//   kMotorKv                           = 63,
//   kReserved_64                       = 64,  // was MotorR
//   kReserved_65                       = 65,  // was MotorL
//   kReserved_66                       = 66,
//   kReserved_67                       = 67,
//   kReserved_68                       = 68,
...
//   kClosedLoopVoltageMode             = 74,  // was kClosedLoopVoltageMode
//   kCompensatedNominalVoltage         = 75,

//   // SmartMotion (slots 0..3)
//   kSmartMotionMaxVelocity_0          = 76,
//   kSmartMotionMaxAccel_0             = 77,
//   kSmartMotionMinVelOutput_0         = 78,
//   kSmartMotionAllowedClosedLoopError_0 = 79,
...
//   // I accumulator limits (slots) + reserved holes
//   kIMaxAccum_0                       = 96,
//   kReserved_97                       = 97,
//   kReserved_98                       = 98,
//   kReserved_99                       = 99,
...
//   // Unit conversion & closed-loop ramp
//   kPositionConversionFactor          = 112,
//   kVelocityConversionFactor          = 113,
//   kClosedLoopRampRate                = 114,
...
//   // Compatibility / data port & alt encoder
//   kDataPortConfig                    = 127, // was kDataPortConfig
//   kAltEncoderCountsPerRev            = 128,
//   kAltEncoderAverageDepth            = 129,
//   kAltEncoderSampleDelta             = 130,
//   kAltEncoderInverted                = 131,
...
//   // UVW sensor
//   kUvwSensorSampleRate               = 136,
//   kUvwSensorAverageDepth             = 137,
...
//   kDutyCyclePrescalar                = 153, // was DutyCyclePrescalar
//   kDutyCycleZeroOffset                   = 154, // newer replacement
...
//   // Duty cycle encoder pulse hints
...
enum class CtrlType : uint8_t
{
  ...
  kSmartMotion = 4,
  kSmartVelocity = 5,
  kMaxMotionPosition = 6,
  kMaxMotionVelocity = 7
};
...
struct Period1Status
{
  // fault stuff not being used rn
  std::chrono::steady_clock::time_point timestamp;
};

/**
 * @brief Periodic status 2 structure (Primary encoder)
 */
struct Period2Status
{
  float position;
...
/**
 * @brief Periodic status 3 structure (Analog Sensor)
 */
struct Period3Status
{
  float analogVoltage;
...
/**
 * @brief Periodic status 4 structure (Alt External Encoder)
 */
struct Period4Status
{
  float altEncoderVelocity;
...
/**
 * @brief Periodic status 5 structure (Duty Cycle Absolute Encoder)
 */
struct Period5Status
{
  float absoluteEncoderVelocity;
...
private:
  ...
  Period5Status period5_{};

  static int                                  soc_;
  static std::atomic<bool>                    rxRunning_;
  static std::thread                          rxThread_;
  static std::unordered_map<uint8_t,SparkBase*> registry_;
  static std::mutex                           registryMtx_;

  static void StartRxThread(const std::string& ifname);
   ...
   */
  // void ReadPeriodicMessages(); // Old
  void HandlePeriodicFrame(const struct can_frame& frame); //New
...
public:
  ...
  void SetPeriodicStatuses(uint8_t enabled);
  ...
  /**
   * @brief Sets the period for periodic status 5
   * @param period The desired status period in milliseconds
   */
  void SetPeriodicStatus5Period(uint16_t period);
  /**
  ...
  // uint32_t GetAbsoluteARBID() const;
